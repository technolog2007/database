...
class ShopTest {
  ...
  void shopNameSetNullAndIsInvalid() {
    Shop shop = new Shop()
        .setName(null)
        .setCity("Sumy")
        .setLocation("str.Ivana Franka, 10");
  ...
  void testToStringSetValuesInObjectAndReturnStringIsEquals() {
    Shop shop = new Shop()
        .setCity("Lviv")
        .setName("Epicenter № 333")
        .setLocation("Lviv, st. Chornovola, b. 10");
    String expected = "Shop{name='Epicenter № 333', "
        + "location='Lviv, st. Chornovola, b. 10', city='Lviv'}";
